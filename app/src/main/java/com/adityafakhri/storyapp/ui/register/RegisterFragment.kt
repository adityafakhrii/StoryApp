...
class RegisterFragment : Fragment() {
    ...
    private fun playAnimation() {
        ...
        val title = ObjectAnimator.ofFloat(binding.titleRegisterTextView, View.ALPHA, 1f).setDuration(500)
        ...
        AnimatorSet().apply {
            playSequentially(title, message, nameEditTextLayout, emailEditTextLayout, passwordEditTextLayout, login, register)
            startDelay = 500
        }.start()
    }
}